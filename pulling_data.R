...
writeOGR(obj=merge, dsn="/Users/sunnyshao/Dropbox/AAPI DATA Desktop/census planning/topAA", layer="topaa", driver="ESRI Shapefile") # this is in geographical projection
##############
