...
aa_ct <- get_acs(table = "B02015", year = 2017, geography = "county", summary_var = "B02016_001", cache_table = T)
...
merge <- geo_join(combined_generalized, top_aa, "GEOID", "GEOID")
writeOGR(obj=merge, dsn="/Users/sunnyshao/Dropbox/AAPI DATA Desktop/census planning/CT_AA", layer="CT_AA", driver="ESRI Shapefile") # this is in geographical projection
##############
